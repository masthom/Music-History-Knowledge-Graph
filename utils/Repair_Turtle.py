...
input_path = Path("Music-History-Knowledge-Graph/MusicHistoryGraph_TwelveToneMusic_Complete.ttl")
output_path = Path("Music-History-Knowledge-Graph/MusicHistoryGraph_TwelveToneMusic_Complete_FIXED.ttl")
